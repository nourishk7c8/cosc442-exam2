...
public class MegaMek {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logFileName = getLogFilenAME(logFileName, lf);
	...
	private static void catchBlock(CommandLineParser.ParseException e) {
	...
	private static void startServerOrGui(CommandLineParser cp, String[] restArgs) {
	...
	private static String getLogFilenAME(String logFileName, String lf) {
		if (lf != null) {
